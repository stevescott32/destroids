...
Game.objects.AsteroidManager = function (managerSpec) {
  ...
  function generateNewAsteroid() {
    ...
    asteroidsMade += 1; 
    if(sizeCategory > 1) {
      asteroidsMade += 3 + (3 % sizeCategory);
      if(sizeCategory > 2) { asteroidsMade += 3 * 4; } 
      while(asteroidsMade > asteroidsToMake && sizeCategory > 1) {
        asteroidsMade -= 3 + (3 % sizeCategory);
        sizeCategory--; 
      }
    }
    ...
    console.log(`Asteroids made ${ asteroidsMade }`); 
